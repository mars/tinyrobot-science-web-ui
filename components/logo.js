...
export default (props) => <svg
  ...
  <g className="robot-face">
    <path d="M49.703,38.537c-8.658,0-15.674-4.655-15.674-10.398c0-5.739,7.016-10.396,15.674-10.396  s15.678,4.657,15.678,10.396C65.381,33.882,58.36,38.537,49.703,38.537z"/>
  </g>
  <g className="robot">
  ...
  <ellipse className="shadow" cx="50" cy="89.5" rx="14" ry="2.5"/>
</svg>
